class TartaMenu_4 {
	...
	{
		idc = 1401;
		onMouseMoving = " if (  _this select 3 && ( ctrltext 1413 isnotequalto '')  ) then {ctrlsettext [1200,'modulos\tartamenu\tartamenu_img\tartamenu\menu_4\s1.paa'];localnamespace setvariable ['TARTAMENU_SELECT',1]}";
