class TartaMenu_3 {
	...
	{
		idc = 1200;
		text = "img\tartamenu\menu_3\fondo.paa";
	...
	{
		idc = 1401;
		onMouseMoving = " if (  _this select 3 && ( ctrltext 1411 isnotequalto '')  ) then {ctrlsettext [1200,'img\tartamenu\menu_3\s1.paa']}";
	...
	{
		idc = 1402;
		onMouseMoving = " if (  _this select 3 && ( ctrltext 1412 isnotequalto '')  ) then {ctrlsettext [1200,'img\tartamenu\menu_3\s2.paa']}";
	...
	{
		idc = 1403;
		onMouseMoving = " if (  _this select 3 && ( ctrltext 1413 isnotequalto '')  ) then {ctrlsettext [1200,'img\tartamenu\menu_3\s3.paa']}";
	...
	{
		idc = 1400;
		onMouseMoving = " if (  _this select 3 && ( ctrltext 1410 isnotequalto '')  ) then {ctrlsettext [1200,'img\tartamenu\menu_3\s0.paa']}";
